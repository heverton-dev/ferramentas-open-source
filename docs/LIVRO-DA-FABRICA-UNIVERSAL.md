...
| **R13** | **Sem Prefixo `_`** | Nenhum arquivo gerado pode começar com `_` (para não ser ocultado por sistemas operacionais e ferramentas de nuvem). |
...
| **R17** | **Etapas Opcionais São Opcionais** | Funcionalidades marcadas como opcionais nunca travam a esteira e sempre perguntam ao usuário se ele deseja sobrescrever ou versionar. |
