...
- 🖥️ **O que você verá na tela:** Uma janela de terminal com cursor piscando, pronta para receber suas instruções.
...
- 🖥️ **O que você verá na tela:** Várias linhas de download e instalação de pacotes passarão pela tela durante 2-3 minutos.
...
- 🖥️ **O que você verá na tela:** Várias linhas de instalação de módulos npm. Ao final, mensagem 'added X packages'.
...
- 🖥️ **O que você verá na tela:** Sem feedback visível, operação silenciosa.
...
- 🖥️ **O que você verá na tela:** Várias linhas de validação de domínio. Mensagem 'Successfully received certificate'.
...
- 🖥️ **O que você verá na tela:** Mensagem 'Started Haraka SMTP Server'.
