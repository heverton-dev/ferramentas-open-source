...
- 🖥️ **O que você verá na tela:** Script executa com credenciais admin geradas.
...
- 🖥️ **O que você verá na tela:** Registros DNS adicionados.
...
- 🖥️ **O que você verá na tela:** Painel exibe usuarios.
...
- 🖥️ **O que você verá na tela:** Emails aparecem nos clientes.
...
- ⚠️ **Alerta de Segurança:** Mantenha backup seguro.
...
- ⚠️ **Alerta de Segurança:** Valide importacao.
...
- ⚠️ **Alerta de Segurança:** NAO remova sem validacao.
