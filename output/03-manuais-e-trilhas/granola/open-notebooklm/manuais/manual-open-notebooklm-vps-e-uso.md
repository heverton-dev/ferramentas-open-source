...
- 🖥️ **O que você verá na tela:** Firewall ativado com confirmação das regras.
...
- 🖥️ **O que você verá na tela:** Instalação automática do motor Docker.
...
- 🖥️ **O que você verá na tela:** Download do código-fonte em segundos.
...
- 🖥️ **O que você verá na tela:** Docker inicia o container e exibe logs de inicialização.
