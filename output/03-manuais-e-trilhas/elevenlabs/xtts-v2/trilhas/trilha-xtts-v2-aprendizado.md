...
## Fase 1: Fundamentos de Audio Neural, Transformers & TTS (`⏱️ 1h 00min`)
...
- [ ] **[XTTS-v2 Model Card & Weights Overview](https://huggingface.co/coqui/XTTS-v2)** (`Artigo Tecnico` - `[F02]`)
  ...
  - ⏱️ 30 min | 👤 Hugging Face Hub

## Fase 2: Setup de Producao na VPS com Aceleracao NVIDIA GPU (`⏱️ 1h 30min`)
...
- [ ] **[XTTS FastAPI Server Configuration](https://github.com/coqui-ai/TTS/wiki/FastAPI-Server)** (`Lab Interativo` - `[F04]`)
  ...
  - ⏱️ 45 min | 👤 Coqui Community

## Fase 3: Clonagem de Voz Zero-Shot com Amostras Reais (`⏱️ 1h 00min`)
...
- [ ] **[Voice Conditioning & Audio Preprocessing Best Practices](https://arxiv.org/abs/2406.04904)** (`Guia de Engenharia` - `[F05]`)
  ...
  - ⏱️ 30 min | 👤 Eren Golge et al.

## Fase 4: Streaming em Baixa Latencia & Integracao com LLMs (`⏱️ 1h 30min`)
...
## Fase 5: Hardening, Monitoramento & Desinstalacao Cirurgica (`⏱️ 1h 00min`)
...
- [ ] **[Production Hardening & GPU Memory Management](https://github.com/coqui-ai/TTS)** (`Playbook DevOps` - `[F04]`)
  ...
  - ⏱️ 30 min | 👤 Fabrica Universal AIDD
