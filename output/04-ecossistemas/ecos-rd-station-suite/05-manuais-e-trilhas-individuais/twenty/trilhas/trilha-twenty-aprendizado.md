# Trilha Didática de Aprendizado (5 Aulas Práticas): Twenty

> **Ferramenta:** Twenty (CRM Moderno Aberto & Gestão de Funil Comercial)  
> **Pilar:** Grupo 2: Pipeline Comercial, CRM & Contratos | **Substitui:** `RD Station CRM (Módulo de Pipeline Kanban, Oportunidades & Tarefas)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Twenty na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Twenty vs. RD Station CRM (Módulo de Pipeline Kanban, Oportunidades & Tarefas);
...
- **Objetivo:** Integrar o Twenty com os demais módulos do ecossistema.
- **Tópicos:**
