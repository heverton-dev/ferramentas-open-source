# Trilha Didática de Aprendizado (5 Aulas Práticas): SuiteCRM

> **Ferramenta:** SuiteCRM (Suíte Completa Enterprise para Grandes Operações de Vendas)  
> **Pilar:** Grupo 2: Pipeline Comercial, CRM & Contratos | **Substitui:** `Salesforce Sales Cloud / SugarCRM Enterprise`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do SuiteCRM na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: SuiteCRM vs. Salesforce Sales Cloud / SugarCRM Enterprise;
...
- **Objetivo:** Integrar o SuiteCRM com os demais módulos do ecossistema.
- **Tópicos:**
