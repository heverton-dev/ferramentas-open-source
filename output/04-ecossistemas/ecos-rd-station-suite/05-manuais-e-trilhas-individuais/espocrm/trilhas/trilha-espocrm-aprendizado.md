# Trilha Didática de Aprendizado (5 Aulas Práticas): EspoCRM

> **Ferramenta:** EspoCRM (Motor de Regras Corporativas B2B & Workflows)  
> **Pilar:** Grupo 2: Pipeline Comercial, CRM & Contratos | **Substitui:** `RD Station CRM (Módulos Corporativos Avançados & Múltiplos Pipelines)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do EspoCRM na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: EspoCRM vs. RD Station CRM (Módulos Corporativos Avançados & Múltiplos Pipelines);
...
- **Objetivo:** Integrar o EspoCRM com os demais módulos do ecossistema.
- **Tópicos:**
