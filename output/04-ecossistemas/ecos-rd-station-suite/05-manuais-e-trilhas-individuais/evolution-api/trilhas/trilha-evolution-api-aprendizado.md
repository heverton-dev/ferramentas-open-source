# Trilha Didática de Aprendizado (5 Aulas Práticas): Evolution API

> **Ferramenta:** Evolution API (Gateway Profissional de WhatsApp Baileys com Webhooks)  
> **Pilar:** Grupo 3: Atendimento Omnichannel & WhatsApp | **Substitui:** `RD Station Conversas (Conectores Proprietários Z-API / Gupshup)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Evolution API na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Evolution API vs. RD Station Conversas (Conectores Proprietários Z-API / Gupshup);
...
- **Objetivo:** Integrar o Evolution API com os demais módulos do ecossistema.
- **Tópicos:**
