# Trilha Didática de Aprendizado (5 Aulas Práticas): Cal.com

> **Ferramenta:** Cal.com (Agendamento Automatizado de Demonstrações Comerciais)  
> **Pilar:** Grupo 2: Pipeline Comercial, CRM & Contratos | **Substitui:** `RD Station CRM (Agendamentos) / Calendly Integrado`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Cal.com na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Cal.com vs. RD Station CRM (Agendamentos) / Calendly Integrado;
...
- **Objetivo:** Integrar o Cal.com com os demais módulos do ecossistema.
- **Tópicos:**
