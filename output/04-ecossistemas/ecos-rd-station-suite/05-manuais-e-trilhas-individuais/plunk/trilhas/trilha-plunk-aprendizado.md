# Trilha Didática de Aprendizado (5 Aulas Práticas): Plunk

> **Ferramenta:** Plunk (Automação de E-mails Minimalista & Rápida)  
> **Pilar:** Grupo 1: Marketing, Nutrição & Landing Pages | **Substitui:** `RD Station Marketing (Plano Light / Automações Básicas)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Plunk na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Plunk vs. RD Station Marketing (Plano Light / Automações Básicas);
...
- **Objetivo:** Integrar o Plunk com os demais módulos do ecossistema.
- **Tópicos:**
