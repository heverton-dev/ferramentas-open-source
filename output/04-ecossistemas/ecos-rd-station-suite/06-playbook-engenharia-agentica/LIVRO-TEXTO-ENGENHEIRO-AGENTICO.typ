...
#set page(
  ...
  footer: [
    ...
    #text(size: 8pt, fill: rgb("#64748b"), font: "Liberation Sans")[
      #grid(
        columns: (1fr, 1fr),
        [Livro-Texto do Engenheiro Agêntico · RD Station Suite],
...
Objetivo: Preparar e blindar a VPS Ubuntu 24.04 LTS para hospedar a suíte RD Station Suite.
...
Objetivo: Executar os testes de fumaça (Smoke Tests) e auditoria de backup da suíte RD Station Suite.
