# Trilha Didática de Aprendizado (5 Aulas Práticas): Jitsi Meet

> **Ferramenta:** Jitsi Meet (Servidor de Videoconferência Criptografada HD sem Limite de Duração)  
> **Pilar:** Pilar 03: Comunicação Unificada, Chat Corporativo & Videoconferência | **Substitui:** `Penso Meet / Zoom Pro / Google Meet`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Jitsi Meet na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Jitsi Meet vs. Penso Meet / Zoom Pro / Google Meet;
...
- **Objetivo:** Integrar o Jitsi Meet com os demais módulos do ecossistema.
- **Tópicos:**
