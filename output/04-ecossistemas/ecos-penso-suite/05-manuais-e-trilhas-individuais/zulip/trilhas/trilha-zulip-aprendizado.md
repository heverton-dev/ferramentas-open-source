# Trilha Didática de Aprendizado (5 Aulas Práticas): Zulip

> **Ferramenta:** Zulip (Plataforma de Chat em Equipe Organizada por Tópicos e Threads Assíncronas)  
> **Pilar:** Pilar 03: Comunicação Unificada, Chat Corporativo & Videoconferência | **Substitui:** `Penso Chat / Slack`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Zulip na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Zulip vs. Penso Chat / Slack;
...
- **Objetivo:** Integrar o Zulip com os demais módulos do ecossistema.
- **Tópicos:**
