# Trilha Didática de Aprendizado (5 Aulas Práticas): Matrix Synapse & Element

> **Ferramenta:** Matrix Synapse & Element (Rede Aberta e Federada de Comunicação Segura com Criptografia Ponta a Ponta)  
> **Pilar:** Pilar 03: Comunicação Unificada, Chat Corporativo & Videoconferência | **Substitui:** `Penso Chat Seguro`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Matrix Synapse & Element na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Matrix Synapse & Element vs. Penso Chat Seguro;
...
- **Objetivo:** Integrar o Matrix Synapse & Element com os demais módulos do ecossistema.
- **Tópicos:**
