# Trilha Didática de Aprendizado (5 Aulas Práticas): Filebrowser

> **Ferramenta:** Filebrowser (Gerenciador de Arquivos Web Ultra-Leve em Binário Único Go)  
> **Pilar:** Pilar 02: Armazenamento em Nuvem, Drive Corporativo & Documentos | **Substitui:** `Penso Drive Básico`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Filebrowser na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Filebrowser vs. Penso Drive Básico;
...
- **Objetivo:** Integrar o Filebrowser com os demais módulos do ecossistema.
- **Tópicos:**
