# Trilha Didática de Aprendizado (5 Aulas Práticas): Rocket.Chat

> **Ferramenta:** Rocket.Chat (Hub de Comunicação Omnichannel e Mensageria Corporativa Segura)  
> **Pilar:** Pilar 03: Comunicação Unificada, Chat Corporativo & Videoconferência | **Substitui:** `Penso Chat & Atendimento`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Rocket.Chat na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Rocket.Chat vs. Penso Chat & Atendimento;
...
- **Objetivo:** Integrar o Rocket.Chat com os demais módulos do ecossistema.
- **Tópicos:**
