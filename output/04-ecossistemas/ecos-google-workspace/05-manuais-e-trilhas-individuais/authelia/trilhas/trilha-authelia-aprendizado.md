# Trilha Didática de Aprendizado (5 Aulas Práticas): Authelia

> **Ferramenta:** Authelia (SSO e 2FA Leve na Borda do Reverse Proxy)  
> **Pilar:** Grupo 3: Identidade, Segurança & Governança (Admin, SSO, Vault & Endpoint) | **Substitui:** `Google Endpoint Management (MFA na borda)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Authelia na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Authelia vs. Google Endpoint Management (MFA na borda);
...
- **Objetivo:** Integrar o Authelia com os demais módulos do ecossistema.
- **Tópicos:**
