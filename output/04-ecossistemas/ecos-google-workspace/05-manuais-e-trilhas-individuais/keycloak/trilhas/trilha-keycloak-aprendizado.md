# Trilha Didática de Aprendizado (5 Aulas Práticas): Keycloak

> **Ferramenta:** Keycloak (Identity and Access Management Empresarial (Red Hat))  
> **Pilar:** Grupo 3: Identidade, Segurança & Governança (Admin, SSO, Vault & Endpoint) | **Substitui:** `Google Cloud Identity + Admin Console (IAM enterprise)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Keycloak na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Keycloak vs. Google Cloud Identity + Admin Console (IAM enterprise);
...
- **Objetivo:** Integrar o Keycloak com os demais módulos do ecossistema.
- **Tópicos:**
