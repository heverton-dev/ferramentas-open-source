# Trilha Didática de Aprendizado (5 Aulas Práticas): CryptPad

> **Ferramenta:** CryptPad (Suíte Office Criptografada de Ponta a Ponta (Drive, Docs, Sheets, Slides, Forms))  
> **Pilar:** Grupo 2: Produtividade & Gestão de Documentos (Drive, Docs, Sheets, Slides, Forms, Keep, Sites) | **Substitui:** `Google Drive + Docs + Sheets + Slides + Forms + Keep`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do CryptPad na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: CryptPad vs. Google Drive + Docs + Sheets + Slides + Forms + Keep;
...
- **Objetivo:** Integrar o CryptPad com os demais módulos do ecossistema.
- **Tópicos:**
