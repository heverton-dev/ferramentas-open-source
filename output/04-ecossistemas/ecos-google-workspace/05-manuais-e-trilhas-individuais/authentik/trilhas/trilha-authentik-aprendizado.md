# Trilha Didática de Aprendizado (5 Aulas Práticas): Authentik

> **Ferramenta:** Authentik (Plataforma Moderna de Identidade (SSO, MFA & Políticas))  
> **Pilar:** Grupo 3: Identidade, Segurança & Governança (Admin, SSO, Vault & Endpoint) | **Substitui:** `Google Cloud Identity + Admin Console (SSO e federação)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Authentik na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Authentik vs. Google Cloud Identity + Admin Console (SSO e federação);
...
- **Objetivo:** Integrar o Authentik com os demais módulos do ecossistema.
- **Tópicos:**
