# Trilha Didática de Aprendizado (5 Aulas Práticas): Mail-in-a-Box

> **Ferramenta:** Mail-in-a-Box (Servidor de E-mail Completo com Instalação de 1 Script)  
> **Pilar:** Grupo 1: Comunicação Unificada (E-mail, Chat, Vídeo, Agenda & Contatos) | **Substitui:** `Gmail + Google Calendar + Google Contacts (instalação zero-config)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Mail-in-a-Box na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Mail-in-a-Box vs. Gmail + Google Calendar + Google Contacts (instalação zero-config);
...
- **Objetivo:** Integrar o Mail-in-a-Box com os demais módulos do ecossistema.
- **Tópicos:**
