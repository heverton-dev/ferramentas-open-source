# Trilha Didática de Aprendizado (5 Aulas Práticas): ZITADEL

> **Ferramenta:** ZITADEL (IAM Moderno Event-Sourced com OIDC, SAML & MFA)  
> **Pilar:** Grupo 3: Identidade, Segurança & Governança (Admin, SSO, Vault & Endpoint) | **Substitui:** `Google Cloud Identity + Admin Console (IAM moderno)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do ZITADEL na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: ZITADEL vs. Google Cloud Identity + Admin Console (IAM moderno);
...
- **Objetivo:** Integrar o ZITADEL com os demais módulos do ecossistema.
- **Tópicos:**
