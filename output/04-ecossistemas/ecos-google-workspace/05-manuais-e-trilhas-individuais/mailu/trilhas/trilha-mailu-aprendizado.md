# Trilha Didática de Aprendizado (5 Aulas Práticas): Mailu

> **Ferramenta:** Mailu (Servidor de E-mail Dockerizado Leve e Completo)  
> **Pilar:** Grupo 1: Comunicação Unificada (E-mail, Chat, Vídeo, Agenda & Contatos) | **Substitui:** `Gmail + Google Calendar + Google Contacts (carga leve)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Mailu na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Mailu vs. Gmail + Google Calendar + Google Contacts (carga leve);
...
- **Objetivo:** Integrar o Mailu com os demais módulos do ecossistema.
- **Tópicos:**
