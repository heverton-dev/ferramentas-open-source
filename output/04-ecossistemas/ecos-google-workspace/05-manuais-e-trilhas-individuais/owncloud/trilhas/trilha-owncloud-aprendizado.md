# Trilha Didática de Aprendizado (5 Aulas Práticas): ownCloud

> **Ferramenta:** ownCloud (Plataforma Enterprise de Sincronização e Compartilhamento de Arquivos)  
> **Pilar:** Grupo 2: Produtividade & Gestão de Documentos (Drive, Docs, Sheets, Slides, Forms, Keep, Sites) | **Substitui:** `Google Drive (armazenamento e compartilhamento empresarial)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do ownCloud na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: ownCloud vs. Google Drive (armazenamento e compartilhamento empresarial);
...
- **Objetivo:** Integrar o ownCloud com os demais módulos do ecossistema.
- **Tópicos:**
