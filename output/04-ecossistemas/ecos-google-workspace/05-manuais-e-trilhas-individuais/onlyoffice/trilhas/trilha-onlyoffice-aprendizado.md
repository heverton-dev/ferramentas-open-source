# Trilha Didática de Aprendizado (5 Aulas Práticas): ONLYOFFICE Docs

> **Ferramenta:** ONLYOFFICE Docs (Motor de Edição Colaborativa Moderna (Docs, Sheets, Slides))  
> **Pilar:** Grupo 2: Produtividade & Gestão de Documentos (Drive, Docs, Sheets, Slides, Forms, Keep, Sites) | **Substitui:** `Google Docs + Sheets + Slides (edição colaborativa)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do ONLYOFFICE Docs na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: ONLYOFFICE Docs vs. Google Docs + Sheets + Slides (edição colaborativa);
...
- **Objetivo:** Integrar o ONLYOFFICE Docs com os demais módulos do ecossistema.
- **Tópicos:**
