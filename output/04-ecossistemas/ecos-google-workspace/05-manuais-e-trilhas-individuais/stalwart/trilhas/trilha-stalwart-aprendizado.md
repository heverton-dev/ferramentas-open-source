# Trilha Didática de Aprendizado (5 Aulas Práticas): Stalwart Mail Server

> **Ferramenta:** Stalwart Mail Server (Servidor de E-mail Moderno em Rust com JMAP, CalDAV & CardDAV)  
> **Pilar:** Grupo 1: Comunicação Unificada (E-mail, Chat, Vídeo, Agenda & Contatos) | **Substitui:** `Gmail + Google Calendar + Google Contacts (protocolo moderno)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Stalwart Mail Server na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Stalwart Mail Server vs. Gmail + Google Calendar + Google Contacts (protocolo moderno);
...
- **Objetivo:** Integrar o Stalwart Mail Server com os demais módulos do ecossistema.
- **Tópicos:**
