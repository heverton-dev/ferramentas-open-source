# Trilha Didática de Aprendizado (5 Aulas Práticas): Casdoor

> **Ferramenta:** Casdoor (SSO All-in-One com UI Amigável e LDAP)  
> **Pilar:** Grupo 3: Identidade, Segurança & Governança (Admin, SSO, Vault & Endpoint) | **Substitui:** `Google Cloud Identity (SSO simples)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Casdoor na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Casdoor vs. Google Cloud Identity (SSO simples);
...
- **Objetivo:** Integrar o Casdoor com os demais módulos do ecossistema.
- **Tópicos:**
