...
> **Pilar:** Grupo 1: Comunicação Unificada (E-mail, Chat, Vídeo, Agenda & Contatos) | **Substitui:** `Gmail + Google Calendar + Google Contacts + Google Chat + Google Meet`  
...
- **Tópicos:**
  1. Comparativo de recursos: Nextcloud Hub vs. Gmail + Google Calendar + Google Contacts + Google Chat + Google Meet;
