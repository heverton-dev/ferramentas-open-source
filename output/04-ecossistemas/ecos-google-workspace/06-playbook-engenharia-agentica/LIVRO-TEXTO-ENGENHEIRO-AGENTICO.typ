...
#set page(
  ...
  footer: [
    ...
    #text(size: 8pt, fill: rgb("#64748b"), font: "Liberation Sans")[
      #grid(
        columns: (1fr, 1fr),
        [Livro-Texto do Engenheiro Agêntico · Google Workspace Soberano],
...
#align(center)[
  ...
  #v(4pt)
  #text(size: 9.5pt, weight: "bold", fill: rgb("#00875a"))[Suíte Alvo: Google Workspace Soberano · Substitui Google Workspace (Business Standard 50 usuários + Google Vault + Endpoint Management)]
  #v(14pt)
]
...
Objetivo: Preparar e blindar a VPS Ubuntu 24.04 LTS para hospedar a suíte Google Workspace Soberano.
...
Objetivo: Realizar o deploy completo da suíte Google Workspace Soberano (Google Workspace (Business Standard 50 usuários + Google Vault + Endpoint Management)).
...
Objetivo: Configurar a observabilidade em tempo real e os canais de alerta da suíte Google Workspace Soberano.
...
Objetivo: Executar os testes de fumaça (Smoke Tests) e auditoria de backup da suíte Google Workspace Soberano.
