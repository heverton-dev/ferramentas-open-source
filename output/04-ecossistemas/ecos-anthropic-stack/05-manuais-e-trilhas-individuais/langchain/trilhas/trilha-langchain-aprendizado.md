# Trilha Didática de Aprendizado (5 Aulas Práticas): LangChain

> **Ferramenta:** LangChain (Framework de Composição de Agentes, Chains & Memory para LLMs)  
> **Pilar:** Grupo 1: Orchestração de Agentes & Modelos LLM | **Substitui:** `Anthropic Claude Code / Managed Agents Runtime`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do LangChain na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: LangChain vs. Anthropic Claude Code / Managed Agents Runtime;
...
- **Objetivo:** Integrar o LangChain com os demais módulos do ecossistema.
- **Tópicos:**
