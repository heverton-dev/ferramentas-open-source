# Trilha Didática de Aprendizado (5 Aulas Práticas): AnythingLLM

> **Ferramenta:** AnythingLLM (RAG Platform All-in-One com Chat Interface)  
> **Pilar:** Grupo 1: Orchestração de Agentes & Modelos LLM | **Substitui:** `ChatGPT / Claude Cloud (Knowledge Base)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do AnythingLLM na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: AnythingLLM vs. ChatGPT / Claude Cloud (Knowledge Base);
...
- **Objetivo:** Integrar o AnythingLLM com os demais módulos do ecossistema.
- **Tópicos:**
