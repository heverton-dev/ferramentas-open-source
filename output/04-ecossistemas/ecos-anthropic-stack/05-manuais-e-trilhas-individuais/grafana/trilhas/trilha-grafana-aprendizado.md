# Trilha Didática de Aprendizado (5 Aulas Práticas): Grafana

> **Ferramenta:** Grafana (Plataforma de Dashboards & Alertas para Observabilidade)  
> **Pilar:** Grupo 3: Observabilidade, Monitoramento & Suporte | **Substitui:** `DataDog / New Relic (Dashboarding)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Grafana na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Grafana vs. DataDog / New Relic (Dashboarding);
...
- **Objetivo:** Integrar o Grafana com os demais módulos do ecossistema.
- **Tópicos:**
