# Trilha Didática de Aprendizado (5 Aulas Práticas): MinIO

> **Ferramenta:** MinIO (Object Storage S3-Compatible para Artefatos & Backups)  
> **Pilar:** Grupo 2: Infraestrutura de Desenvolvimento, CI/CD & Versionamento | **Substitui:** `AWS S3 / Google Cloud Storage`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do MinIO na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: MinIO vs. AWS S3 / Google Cloud Storage;
...
- **Objetivo:** Integrar o MinIO com os demais módulos do ecossistema.
- **Tópicos:**
