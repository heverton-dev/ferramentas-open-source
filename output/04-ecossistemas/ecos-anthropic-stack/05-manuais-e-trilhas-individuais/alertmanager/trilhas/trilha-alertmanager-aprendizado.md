# Trilha Didática de Aprendizado (5 Aulas Práticas): Alertmanager

> **Ferramenta:** Alertmanager (Gerenciador de Alertas & Deduplicação)  
> **Pilar:** Grupo 3: Observabilidade, Monitoramento & Suporte | **Substitui:** `PagerDuty (Alert Routing)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Alertmanager na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Alertmanager vs. PagerDuty (Alert Routing);
...
- **Objetivo:** Integrar o Alertmanager com os demais módulos do ecossistema.
- **Tópicos:**
