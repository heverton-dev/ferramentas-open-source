# Trilha Didática de Aprendizado (5 Aulas Práticas): LlamaIndex

> **Ferramenta:** LlamaIndex (Framework de RAG (Retrieval-Augmented Generation) com Vector Stores)  
> **Pilar:** Grupo 1: Orchestração de Agentes & Modelos LLM | **Substitui:** `Anthropic Claude Code / Knowledge Base Built-in`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do LlamaIndex na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: LlamaIndex vs. Anthropic Claude Code / Knowledge Base Built-in;
...
- **Objetivo:** Integrar o LlamaIndex com os demais módulos do ecossistema.
- **Tópicos:**
