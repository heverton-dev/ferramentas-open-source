# Trilha Didática de Aprendizado (5 Aulas Práticas): Loki

> **Ferramenta:** Loki (Log Aggregation System com Índices Otimizados)  
> **Pilar:** Grupo 3: Observabilidade, Monitoramento & Suporte | **Substitui:** `DataDog / Splunk / Elasticsearch (Logging)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Loki na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Loki vs. DataDog / Splunk / Elasticsearch (Logging);
...
- **Objetivo:** Integrar o Loki com os demais módulos do ecossistema.
- **Tópicos:**
