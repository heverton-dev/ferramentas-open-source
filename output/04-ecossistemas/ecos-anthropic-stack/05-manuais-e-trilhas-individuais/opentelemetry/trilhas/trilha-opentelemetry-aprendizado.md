# Trilha Didática de Aprendizado (5 Aulas Práticas): OpenTelemetry Collector

> **Ferramenta:** OpenTelemetry Collector (Coleta & Processamento Agnóstico de Traces, Métricas & Logs)  
> **Pilar:** Grupo 3: Observabilidade, Monitoramento & Suporte | **Substitui:** `Datadog / New Relic / Sentry (Tracing & Collection)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do OpenTelemetry Collector na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: OpenTelemetry Collector vs. Datadog / New Relic / Sentry (Tracing & Collection);
...
- **Objetivo:** Integrar o OpenTelemetry Collector com os demais módulos do ecossistema.
- **Tópicos:**
