# Trilha Didática de Aprendizado (5 Aulas Práticas): Prometheus

> **Ferramenta:** Prometheus (Time-Series Database & Scraper de Métricas)  
> **Pilar:** Grupo 3: Observabilidade, Monitoramento & Suporte | **Substitui:** `DataDog / New Relic (Infrastructure Monitoring)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Prometheus na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Prometheus vs. DataDog / New Relic (Infrastructure Monitoring);
...
- **Objetivo:** Integrar o Prometheus com os demais módulos do ecossistema.
- **Tópicos:**
