# Trilha Didática de Aprendizado (5 Aulas Práticas): Deno

> **Ferramenta:** Deno (Runtime JavaScript/TypeScript Moderno com Permissões Granulares)  
> **Pilar:** Grupo 2: Infraestrutura de Desenvolvimento, CI/CD & Versionamento | **Substitui:** `Node.js (elimina dependência de npm/package.json)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Deno na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Deno vs. Node.js (elimina dependência de npm/package.json);
...
- **Objetivo:** Integrar o Deno com os demais módulos do ecossistema.
- **Tópicos:**
