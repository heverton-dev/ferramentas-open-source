# Trilha Didática de Aprendizado (5 Aulas Práticas): Docker Registry

> **Ferramenta:** Docker Registry (Registro Privado de Imagens Docker)  
> **Pilar:** Grupo 2: Infraestrutura de Desenvolvimento, CI/CD & Versionamento | **Substitui:** `Docker Hub (Private Repos) / ECR / GCR`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Docker Registry na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Docker Registry vs. Docker Hub (Private Repos) / ECR / GCR;
...
- **Objetivo:** Integrar o Docker Registry com os demais módulos do ecossistema.
- **Tópicos:**
