# Trilha Didática de Aprendizado (5 Aulas Práticas): Flowise

> **Ferramenta:** Flowise (Construtor Visual Drag-and-Drop de Workflows de IA)  
> **Pilar:** Grupo 1: Orchestração de Agentes & Modelos LLM | **Substitui:** `Anthropic Claude Code (Visual Agent Builder)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Flowise na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Flowise vs. Anthropic Claude Code (Visual Agent Builder);
...
- **Objetivo:** Integrar o Flowise com os demais módulos do ecossistema.
- **Tópicos:**
