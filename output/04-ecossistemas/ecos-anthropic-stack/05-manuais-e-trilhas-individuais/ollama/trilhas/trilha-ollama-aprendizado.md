# Trilha Didática de Aprendizado (5 Aulas Práticas): Ollama

> **Ferramenta:** Ollama (Executor Local de Modelos LLM Abertos (Llama 2, Mistral, Neural Chat))  
> **Pilar:** Grupo 1: Orchestração de Agentes & Modelos LLM | **Substitui:** `Anthropic Claude API (Tier Enterprise / Managed Agents)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Ollama na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Ollama vs. Anthropic Claude API (Tier Enterprise / Managed Agents);
...
- **Objetivo:** Integrar o Ollama com os demais módulos do ecossistema.
- **Tópicos:**
