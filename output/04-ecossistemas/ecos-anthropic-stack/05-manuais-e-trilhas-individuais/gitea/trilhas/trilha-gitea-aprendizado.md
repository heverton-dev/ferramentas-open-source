# Trilha Didática de Aprendizado (5 Aulas Práticas): Gitea

> **Ferramenta:** Gitea (Servidor Git Auto-Hospedado Leve com Interface Web)  
> **Pilar:** Grupo 2: Infraestrutura de Desenvolvimento, CI/CD & Versionamento | **Substitui:** `GitHub (Team Plan) / GitLab (Premium)`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Gitea na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Gitea vs. GitHub (Team Plan) / GitLab (Premium);
...
- **Objetivo:** Integrar o Gitea com os demais módulos do ecossistema.
- **Tópicos:**
