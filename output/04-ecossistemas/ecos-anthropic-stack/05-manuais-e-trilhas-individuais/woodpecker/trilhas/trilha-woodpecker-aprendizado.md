# Trilha Didática de Aprendizado (5 Aulas Práticas): Woodpecker CI

> **Ferramenta:** Woodpecker CI (Motor de CI/CD Moderno com Suporte a Containers & Kubernetes)  
> **Pilar:** Grupo 2: Infraestrutura de Desenvolvimento, CI/CD & Versionamento | **Substitui:** `GitHub Actions / GitLab CI / Jenkins`  
> **Carga Horária Estimada:** 5 horas (1 hora por aula prática)  

---

## Aula 01: Fundamentos & O que a Ferramenta Substitui
- **Objetivo:** Compreender o papel do Woodpecker CI na infraestrutura soberana da empresa.
- **Tópicos:**
  1. Comparativo de recursos: Woodpecker CI vs. GitHub Actions / GitLab CI / Jenkins;
...
- **Objetivo:** Integrar o Woodpecker CI com os demais módulos do ecossistema.
- **Tópicos:**
