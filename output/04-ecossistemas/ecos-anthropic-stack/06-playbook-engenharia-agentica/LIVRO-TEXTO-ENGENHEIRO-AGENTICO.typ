...
#set page(
  ...
  footer: [
    ...
    #text(size: 8pt, fill: rgb("#64748b"), font: "Liberation Sans")[
      #grid(
        columns: (1fr, 1fr),
        [Livro-Texto do Engenheiro Agêntico · Anthropic Stack Soberano],
...
#align(center)[
  ...
  #v(4pt)
  #text(size: 9.5pt, weight: "bold", fill: rgb("#00875a"))[Suíte Alvo: Anthropic Stack Soberano · Substitui Anthropic Claude API + Claude Code + MCP Protocol + AI Gateway + Managed Agents]
  #v(14pt)
]
...
Objetivo: Realizar o deploy completo da suíte Anthropic Stack Soberano (Anthropic Claude API + Claude Code + MCP Protocol + AI Gateway + Managed Agents).
...
Objetivo: Configurar a observabilidade em tempo real e os canais de alerta da suíte Anthropic Stack Soberano.
