...
| :---: | :--- | :--- | :---: | :---: | :---: |
| `#01` | *A Mais Robusta* | **Scribus (O Software Profissional de Editoração Eletrônica e Pré-Impressão Gráfica)** | `GPL-2.0` | `Mínimo (Plug & Play)` | `APROVADO` |
| `#02` | *A Mais Completa* | **Typst (O Novo e Revolucionário Sistema de Composição Tipográfica Baseado em Código)** | `Apache-2.0` | `Headless (API / CLI First)` | `APROVADO` |
| `#03` | *A Mais Moderna* | **WeasyPrint (Motor de Diagramação de Livros e Catálogos a Partir de HTML5 e CSS)** | `BSD-3-Clause` | `Headless (API / CLI First)` | `APROVADO` |
| `#04` | *A Mais Leve* | **Paged.js (A Biblioteca JavaScript para Paginar Documentos no Navegador)** | `MIT` | `Mínimo (Plug & Play)` | `APROVADO` |
| `#05` | *A Mais Simples* | **Marp (Apresentações, Relatórios e Manuais Diagramados a Partir de Markdown)** | `MIT` | `Mínimo (Plug & Play)` | `APROVADO` |
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5-V)** | `vert-indesign.html` | 68,311 bytes | `8bd19c4b61b3` |
| **Markdown Limpo Estruturado** | `vert-indesign.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `vert-indesign.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Dossiê Interativo** | `vert-indesign.html` | HTML | `../materiais/vert-indesign.html` |
| **Dossiê Markdown** | `vert-indesign.md` | Markdown | `../materiais/vert-indesign.md` |
| **Dossiê PDF** | `vert-indesign.pdf` | PDF (Typst) | `../materiais/vert-indesign.pdf` |
