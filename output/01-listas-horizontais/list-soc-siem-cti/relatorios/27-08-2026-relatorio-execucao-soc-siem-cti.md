# Relatório Oficial de Execução & Telemetria · Fluxo 1: Soc Siem Cti
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-soc-siem-cti.html` | 105,639 bytes | `7c45c8254372` |
| **Markdown Denso Estruturado** | `list-soc-siem-cti.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-soc-siem-cti.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-soc-siem-cti.html` | HTML | `../materiais/list-soc-siem-cti.html` |
| **Compêndio Markdown** | `list-soc-siem-cti.md` | Markdown | `../materiais/list-soc-siem-cti.md` |
| **Compêndio PDF** | `list-soc-siem-cti.pdf` | PDF (Typst) | `../materiais/list-soc-siem-cti.pdf` |
