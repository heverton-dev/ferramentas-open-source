# Relatório Oficial de Execução & Telemetria · Fluxo 1: Fonte Limpa
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-fonte-limpa.html` | 96,834 bytes | `77e1e7d2b5c1` |
| **Markdown Denso Estruturado** | `list-fonte-limpa.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-fonte-limpa.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-fonte-limpa.html` | HTML | `../materiais/list-fonte-limpa.html` |
| **Compêndio Markdown** | `list-fonte-limpa.md` | Markdown | `../materiais/list-fonte-limpa.md` |
| **Compêndio PDF** | `list-fonte-limpa.pdf` | PDF (Typst) | `../materiais/list-fonte-limpa.pdf` |
