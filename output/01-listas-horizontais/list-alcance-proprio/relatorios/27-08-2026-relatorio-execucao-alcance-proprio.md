# Relatório Oficial de Execução & Telemetria · Fluxo 1: Alcance Proprio
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-alcance-proprio.html` | 97,151 bytes | `9b183a5c9586` |
| **Markdown Denso Estruturado** | `list-alcance-proprio.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-alcance-proprio.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-alcance-proprio.html` | HTML | `../materiais/list-alcance-proprio.html` |
| **Compêndio Markdown** | `list-alcance-proprio.md` | Markdown | `../materiais/list-alcance-proprio.md` |
| **Compêndio PDF** | `list-alcance-proprio.pdf` | PDF (Typst) | `../materiais/list-alcance-proprio.pdf` |
