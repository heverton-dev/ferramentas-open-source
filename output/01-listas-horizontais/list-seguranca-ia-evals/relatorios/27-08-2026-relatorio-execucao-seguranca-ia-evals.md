# Relatório Oficial de Execução & Telemetria · Fluxo 1: Seguranca Ia Evals
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-seguranca-ia-evals.html` | 108,626 bytes | `c6f586e28448` |
| **Markdown Denso Estruturado** | `list-seguranca-ia-evals.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-seguranca-ia-evals.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-seguranca-ia-evals.html` | HTML | `../materiais/list-seguranca-ia-evals.html` |
| **Compêndio Markdown** | `list-seguranca-ia-evals.md` | Markdown | `../materiais/list-seguranca-ia-evals.md` |
| **Compêndio PDF** | `list-seguranca-ia-evals.pdf` | PDF (Typst) | `../materiais/list-seguranca-ia-evals.pdf` |
