# Relatório Oficial de Execução & Telemetria · Fluxo 1: Edge Ai Iot
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-edge-ai-iot.html` | 107,767 bytes | `b218f48ba751` |
| **Markdown Denso Estruturado** | `list-edge-ai-iot.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-edge-ai-iot.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-edge-ai-iot.html` | HTML | `../materiais/list-edge-ai-iot.html` |
| **Compêndio Markdown** | `list-edge-ai-iot.md` | Markdown | `../materiais/list-edge-ai-iot.md` |
| **Compêndio PDF** | `list-edge-ai-iot.pdf` | PDF (Typst) | `../materiais/list-edge-ai-iot.pdf` |
