# Relatório Oficial de Execução & Telemetria · Fluxo 1: Lakehouse Dados
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-lakehouse-dados.html` | 105,185 bytes | `b38d1b84e116` |
| **Markdown Denso Estruturado** | `list-lakehouse-dados.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-lakehouse-dados.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-lakehouse-dados.html` | HTML | `../materiais/list-lakehouse-dados.html` |
| **Compêndio Markdown** | `list-lakehouse-dados.md` | Markdown | `../materiais/list-lakehouse-dados.md` |
| **Compêndio PDF** | `list-lakehouse-dados.pdf` | PDF (Typst) | `../materiais/list-lakehouse-dados.pdf` |
