# Relatório Oficial de Execução & Telemetria · Fluxo 1: Financas Pagamentos
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-financas-pagamentos.html` | 108,582 bytes | `7ccb395e48df` |
| **Markdown Denso Estruturado** | `list-financas-pagamentos.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-financas-pagamentos.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-financas-pagamentos.html` | HTML | `../materiais/list-financas-pagamentos.html` |
| **Compêndio Markdown** | `list-financas-pagamentos.md` | Markdown | `../materiais/list-financas-pagamentos.md` |
| **Compêndio PDF** | `list-financas-pagamentos.pdf` | PDF (Typst) | `../materiais/list-financas-pagamentos.pdf` |
