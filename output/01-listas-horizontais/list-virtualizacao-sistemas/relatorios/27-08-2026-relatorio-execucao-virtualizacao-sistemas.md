# Relatório Oficial de Execução & Telemetria · Fluxo 1: Virtualizacao Sistemas
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-virtualizacao-sistemas.html` | 108,752 bytes | `7fff8758eae5` |
| **Markdown Denso Estruturado** | `list-virtualizacao-sistemas.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-virtualizacao-sistemas.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-virtualizacao-sistemas.html` | HTML | `../materiais/list-virtualizacao-sistemas.html` |
| **Compêndio Markdown** | `list-virtualizacao-sistemas.md` | Markdown | `../materiais/list-virtualizacao-sistemas.md` |
| **Compêndio PDF** | `list-virtualizacao-sistemas.pdf` | PDF (Typst) | `../materiais/list-virtualizacao-sistemas.pdf` |
