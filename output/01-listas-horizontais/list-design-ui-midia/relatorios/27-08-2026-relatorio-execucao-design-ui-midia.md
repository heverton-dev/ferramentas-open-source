# Relatório Oficial de Execução & Telemetria · Fluxo 1: Design Ui Midia
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-design-ui-midia.html` | 98,514 bytes | `b1ce20aa1169` |
| **Markdown Denso Estruturado** | `list-design-ui-midia.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-design-ui-midia.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-design-ui-midia.html` | HTML | `../materiais/list-design-ui-midia.html` |
| **Compêndio Markdown** | `list-design-ui-midia.md` | Markdown | `../materiais/list-design-ui-midia.md` |
| **Compêndio PDF** | `list-design-ui-midia.pdf` | PDF (Typst) | `../materiais/list-design-ui-midia.pdf` |
