# Relatório Oficial de Execução & Telemetria · Fluxo 1: Cad Fabricacao Eda
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-cad-fabricacao-eda.html` | 107,576 bytes | `8b1e60a7ab18` |
| **Markdown Denso Estruturado** | `list-cad-fabricacao-eda.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-cad-fabricacao-eda.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-cad-fabricacao-eda.html` | HTML | `../materiais/list-cad-fabricacao-eda.html` |
| **Compêndio Markdown** | `list-cad-fabricacao-eda.md` | Markdown | `../materiais/list-cad-fabricacao-eda.md` |
| **Compêndio PDF** | `list-cad-fabricacao-eda.pdf` | PDF (Typst) | `../materiais/list-cad-fabricacao-eda.pdf` |
