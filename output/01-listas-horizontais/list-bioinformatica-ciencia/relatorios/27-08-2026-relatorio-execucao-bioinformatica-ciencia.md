# Relatório Oficial de Execução & Telemetria · Fluxo 1: Bioinformatica Ciencia

> **Data de Execução:** 27/08/2026  
> **Janela de Tempo:** Início: 16:35:10 | Término: 17:12:43 | Duração Total: 2m 14s  
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-bioinformatica-ciencia.html` | 108,263 bytes | `c919d8152257` |
| **Markdown Denso Estruturado** | `list-bioinformatica-ciencia.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-bioinformatica-ciencia.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-bioinformatica-ciencia.html` | HTML | `../materiais/list-bioinformatica-ciencia.html` |
| **Compêndio Markdown** | `list-bioinformatica-ciencia.md` | Markdown | `../materiais/list-bioinformatica-ciencia.md` |
| **Compêndio PDF** | `list-bioinformatica-ciencia.pdf` | PDF (Typst) | `../materiais/list-bioinformatica-ciencia.pdf` |
