# Relatório Oficial de Execução & Telemetria · Fluxo 1: Acessibilidade Ergonomia

> **Data de Execução:** 27/08/2026  
> **Janela de Tempo:** Início: 16:35:10 | Término: 17:12:42 | Duração Total: 2m 14s  
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-acessibilidade-ergonomia.html` | 108,627 bytes | `00be21d073d2` |
| **Markdown Denso Estruturado** | `list-acessibilidade-ergonomia.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-acessibilidade-ergonomia.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-acessibilidade-ergonomia.html` | HTML | `../materiais/list-acessibilidade-ergonomia.html` |
| **Compêndio Markdown** | `list-acessibilidade-ergonomia.md` | Markdown | `../materiais/list-acessibilidade-ergonomia.md` |
| **Compêndio PDF** | `list-acessibilidade-ergonomia.pdf` | PDF (Typst) | `../materiais/list-acessibilidade-ergonomia.pdf` |
