# Relatório Oficial de Execução & Telemetria · Fluxo 1: Engenharia Reversa
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-engenharia-reversa.html` | 108,494 bytes | `929f05c5b98d` |
| **Markdown Denso Estruturado** | `list-engenharia-reversa.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-engenharia-reversa.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-engenharia-reversa.html` | HTML | `../materiais/list-engenharia-reversa.html` |
| **Compêndio Markdown** | `list-engenharia-reversa.md` | Markdown | `../materiais/list-engenharia-reversa.md` |
| **Compêndio PDF** | `list-engenharia-reversa.pdf` | PDF (Typst) | `../materiais/list-engenharia-reversa.pdf` |
