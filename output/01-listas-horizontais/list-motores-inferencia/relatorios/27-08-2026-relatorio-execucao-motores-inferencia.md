# Relatório Oficial de Execução & Telemetria · Fluxo 1: Motores Inferencia
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-motores-inferencia.html` | 108,238 bytes | `4fc900955a74` |
| **Markdown Denso Estruturado** | `list-motores-inferencia.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-motores-inferencia.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-motores-inferencia.html` | HTML | `../materiais/list-motores-inferencia.html` |
| **Compêndio Markdown** | `list-motores-inferencia.md` | Markdown | `../materiais/list-motores-inferencia.md` |
| **Compêndio PDF** | `list-motores-inferencia.pdf` | PDF (Typst) | `../materiais/list-motores-inferencia.pdf` |
