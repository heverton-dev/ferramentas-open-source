# Relatório Oficial de Execução & Telemetria · Fluxo 1: Caixa Aberto
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-caixa-aberto.html` | 95,910 bytes | `b6cba80b152b` |
| **Markdown Denso Estruturado** | `list-caixa-aberto.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-caixa-aberto.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-caixa-aberto.html` | HTML | `../materiais/list-caixa-aberto.html` |
| **Compêndio Markdown** | `list-caixa-aberto.md` | Markdown | `../materiais/list-caixa-aberto.md` |
| **Compêndio PDF** | `list-caixa-aberto.pdf` | PDF (Typst) | `../materiais/list-caixa-aberto.pdf` |
