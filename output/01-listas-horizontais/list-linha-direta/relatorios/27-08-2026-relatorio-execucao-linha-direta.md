# Relatório Oficial de Execução & Telemetria · Fluxo 1: Linha Direta
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-linha-direta.html` | 95,734 bytes | `da22c54a927e` |
| **Markdown Denso Estruturado** | `list-linha-direta.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-linha-direta.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-linha-direta.html` | HTML | `../materiais/list-linha-direta.html` |
| **Compêndio Markdown** | `list-linha-direta.md` | Markdown | `../materiais/list-linha-direta.md` |
| **Compêndio PDF** | `list-linha-direta.pdf` | PDF (Typst) | `../materiais/list-linha-direta.pdf` |
