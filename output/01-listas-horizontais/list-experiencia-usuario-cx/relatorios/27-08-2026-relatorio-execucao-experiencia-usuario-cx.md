...
> **Camada Temática:** `list-experiencia-usuario-cx` | **Status Geral:** `100% APROVADO`
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-experiencia-usuario-cx.html` | HTML | `../materiais/list-experiencia-usuario-cx.html` |
| **Compêndio Markdown** | `list-experiencia-usuario-cx.md` | Markdown | `../materiais/list-experiencia-usuario-cx.md` |
| **Compêndio PDF** | `list-experiencia-usuario-cx.pdf` | PDF (Typst) | `../materiais/list-experiencia-usuario-cx.pdf` |
