# Relatório Oficial de Execução & Telemetria · Fluxo 1: Troca Livre
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-troca-livre.html` | 96,644 bytes | `50595aabbb0b` |
| **Markdown Denso Estruturado** | `list-troca-livre.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-troca-livre.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-troca-livre.html` | HTML | `../materiais/list-troca-livre.html` |
| **Compêndio Markdown** | `list-troca-livre.md` | Markdown | `../materiais/list-troca-livre.md` |
| **Compêndio PDF** | `list-troca-livre.pdf` | PDF (Typst) | `../materiais/list-troca-livre.pdf` |
