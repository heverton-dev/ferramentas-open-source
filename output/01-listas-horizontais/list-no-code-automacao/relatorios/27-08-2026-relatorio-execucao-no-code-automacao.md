# Relatório Oficial de Execução & Telemetria · Fluxo 1: No Code Automacao
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-no-code-automacao.html` | 107,210 bytes | `2c531d747d4e` |
| **Markdown Denso Estruturado** | `list-no-code-automacao.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-no-code-automacao.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-no-code-automacao.html` | HTML | `../materiais/list-no-code-automacao.html` |
| **Compêndio Markdown** | `list-no-code-automacao.md` | Markdown | `../materiais/list-no-code-automacao.md` |
| **Compêndio PDF** | `list-no-code-automacao.pdf` | PDF (Typst) | `../materiais/list-no-code-automacao.pdf` |
