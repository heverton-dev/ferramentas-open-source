# Relatório Oficial de Execução & Telemetria · Fluxo 1: Titas Soberania
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-titas-soberania.html` | 114,016 bytes | `1701daef3f48` |
| **Markdown Denso Estruturado** | `list-titas-soberania.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-titas-soberania.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-titas-soberania.html` | HTML | `../materiais/list-titas-soberania.html` |
| **Compêndio Markdown** | `list-titas-soberania.md` | Markdown | `../materiais/list-titas-soberania.md` |
| **Compêndio PDF** | `list-titas-soberania.pdf` | PDF (Typst) | `../materiais/list-titas-soberania.pdf` |
