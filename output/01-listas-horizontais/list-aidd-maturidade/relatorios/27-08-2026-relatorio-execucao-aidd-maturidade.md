# Relatório Oficial de Execução & Telemetria · Fluxo 1: Aidd Maturidade
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-aidd-maturidade.html` | 68,028 bytes | `e6dc92c0ea8d` |
| **Markdown Denso Estruturado** | `list-aidd-maturidade.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-aidd-maturidade.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-aidd-maturidade.html` | HTML | `../materiais/list-aidd-maturidade.html` |
| **Compêndio Markdown** | `list-aidd-maturidade.md` | Markdown | `../materiais/list-aidd-maturidade.md` |
| **Compêndio PDF** | `list-aidd-maturidade.pdf` | PDF (Typst) | `../materiais/list-aidd-maturidade.pdf` |
