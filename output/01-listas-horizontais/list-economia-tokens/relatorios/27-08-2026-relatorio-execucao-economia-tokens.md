# Relatório Oficial de Execução & Telemetria · Fluxo 1: Economia Tokens
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-economia-tokens.html` | 102,662 bytes | `589a182a6fa5` |
| **Markdown Denso Estruturado** | `list-economia-tokens.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-economia-tokens.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-economia-tokens.html` | HTML | `../materiais/list-economia-tokens.html` |
| **Compêndio Markdown** | `list-economia-tokens.md` | Markdown | `../materiais/list-economia-tokens.md` |
| **Compêndio PDF** | `list-economia-tokens.pdf` | PDF (Typst) | `../materiais/list-economia-tokens.pdf` |
