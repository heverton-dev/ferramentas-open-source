# Relatório Oficial de Execução & Telemetria · Fluxo 1: Harnesses Ide Terminal

> **Data de Execução:** 27/08/2026  
> **Janela de Tempo:** Início: 16:35:10 | Término: 17:12:47 | Duração Total: 2m 14s  
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-harnesses-ide-terminal.html` | 108,034 bytes | `328d7ae88ff8` |
| **Markdown Denso Estruturado** | `list-harnesses-ide-terminal.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-harnesses-ide-terminal.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-harnesses-ide-terminal.html` | HTML | `../materiais/list-harnesses-ide-terminal.html` |
| **Compêndio Markdown** | `list-harnesses-ide-terminal.md` | Markdown | `../materiais/list-harnesses-ide-terminal.md` |
| **Compêndio PDF** | `list-harnesses-ide-terminal.pdf` | PDF (Typst) | `../materiais/list-harnesses-ide-terminal.pdf` |
