# Relatório Oficial de Execução & Telemetria · Fluxo 1: Simulacao Robotica

> **Data de Execução:** 27/08/2026  
> **Janela de Tempo:** Início: 16:35:10 | Término: 17:12:49 | Duração Total: 2m 14s  
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-simulacao-robotica.html` | 108,023 bytes | `595f552b0e1d` |
| **Markdown Denso Estruturado** | `list-simulacao-robotica.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-simulacao-robotica.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-simulacao-robotica.html` | HTML | `../materiais/list-simulacao-robotica.html` |
| **Compêndio Markdown** | `list-simulacao-robotica.md` | Markdown | `../materiais/list-simulacao-robotica.md` |
| **Compêndio PDF** | `list-simulacao-robotica.pdf` | PDF (Typst) | `../materiais/list-simulacao-robotica.pdf` |
