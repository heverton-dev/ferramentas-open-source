# Relatório Oficial de Execução & Telemetria · Fluxo 1: Compiladores Wasm
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-compiladores-wasm.html` | 108,445 bytes | `1dc5207b60de` |
| **Markdown Denso Estruturado** | `list-compiladores-wasm.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-compiladores-wasm.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-compiladores-wasm.html` | HTML | `../materiais/list-compiladores-wasm.html` |
| **Compêndio Markdown** | `list-compiladores-wasm.md` | Markdown | `../materiais/list-compiladores-wasm.md` |
| **Compêndio PDF** | `list-compiladores-wasm.pdf` | PDF (Typst) | `../materiais/list-compiladores-wasm.pdf` |
