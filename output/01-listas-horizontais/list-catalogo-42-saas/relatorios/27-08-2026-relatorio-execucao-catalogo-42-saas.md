# Relatório Oficial de Execução & Telemetria · Fluxo 1: Catalogo 42 Saas
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-catalogo-42-saas.html` | 322,144 bytes | `91a90b961509` |
| **Markdown Denso Estruturado** | `list-catalogo-42-saas.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-catalogo-42-saas.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-catalogo-42-saas.html` | HTML | `../materiais/list-catalogo-42-saas.html` |
| **Compêndio Markdown** | `list-catalogo-42-saas.md` | Markdown | `../materiais/list-catalogo-42-saas.md` |
| **Compêndio PDF** | `list-catalogo-42-saas.pdf` | PDF (Typst) | `../materiais/list-catalogo-42-saas.pdf` |
