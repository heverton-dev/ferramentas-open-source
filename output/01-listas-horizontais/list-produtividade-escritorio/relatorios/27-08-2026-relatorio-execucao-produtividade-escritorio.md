# Relatório Oficial de Execução & Telemetria · Fluxo 1: Produtividade Escritorio

> **Data de Execução:** 27/08/2026  
> **Janela de Tempo:** Início: 16:35:10 | Término: 17:12:48 | Duração Total: 2m 14s  
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-produtividade-escritorio.html` | 122,603 bytes | `4bff78ca243d` |
| **Markdown Denso Estruturado** | `list-produtividade-escritorio.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-produtividade-escritorio.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-produtividade-escritorio.html` | HTML | `../materiais/list-produtividade-escritorio.html` |
| **Compêndio Markdown** | `list-produtividade-escritorio.md` | Markdown | `../materiais/list-produtividade-escritorio.md` |
| **Compêndio PDF** | `list-produtividade-escritorio.pdf` | PDF (Typst) | `../materiais/list-produtividade-escritorio.pdf` |
