# Relatório Oficial de Execução & Telemetria · Fluxo 1: Arsenal Engenheiro Ia
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-arsenal-engenheiro-ia.html` | 128,614 bytes | `b18fe375b716` |
| **Markdown Denso Estruturado** | `list-arsenal-engenheiro-ia.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-arsenal-engenheiro-ia.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-arsenal-engenheiro-ia.html` | HTML | `../materiais/list-arsenal-engenheiro-ia.html` |
| **Compêndio Markdown** | `list-arsenal-engenheiro-ia.md` | Markdown | `../materiais/list-arsenal-engenheiro-ia.md` |
| **Compêndio PDF** | `list-arsenal-engenheiro-ia.pdf` | PDF (Typst) | `../materiais/list-arsenal-engenheiro-ia.pdf` |
