# Relatório Oficial de Execução & Telemetria · Fluxo 1: Redes P2P
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-redes-p2p.html` | 107,924 bytes | `48c6e5e40292` |
| **Markdown Denso Estruturado** | `list-redes-p2p.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-redes-p2p.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-redes-p2p.html` | HTML | `../materiais/list-redes-p2p.html` |
| **Compêndio Markdown** | `list-redes-p2p.md` | Markdown | `../materiais/list-redes-p2p.md` |
| **Compêndio PDF** | `list-redes-p2p.pdf` | PDF (Typst) | `../materiais/list-redes-p2p.pdf` |
