# Relatório Oficial de Execução & Telemetria · Fluxo 1: Rag Vetores Grafos
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-rag-vetores-grafos.html` | 108,051 bytes | `ab944073d37a` |
| **Markdown Denso Estruturado** | `list-rag-vetores-grafos.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-rag-vetores-grafos.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-rag-vetores-grafos.html` | HTML | `../materiais/list-rag-vetores-grafos.html` |
| **Compêndio Markdown** | `list-rag-vetores-grafos.md` | Markdown | `../materiais/list-rag-vetores-grafos.md` |
| **Compêndio PDF** | `list-rag-vetores-grafos.pdf` | PDF (Typst) | `../materiais/list-rag-vetores-grafos.pdf` |
