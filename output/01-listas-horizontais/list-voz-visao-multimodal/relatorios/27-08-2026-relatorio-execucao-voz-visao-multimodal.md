# Relatório Oficial de Execução & Telemetria · Fluxo 1: Voz Visao Multimodal
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-voz-visao-multimodal.html` | 107,822 bytes | `ed97c5511e26` |
| **Markdown Denso Estruturado** | `list-voz-visao-multimodal.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-voz-visao-multimodal.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-voz-visao-multimodal.html` | HTML | `../materiais/list-voz-visao-multimodal.html` |
| **Compêndio Markdown** | `list-voz-visao-multimodal.md` | Markdown | `../materiais/list-voz-visao-multimodal.md` |
| **Compêndio PDF** | `list-voz-visao-multimodal.pdf` | PDF (Typst) | `../materiais/list-voz-visao-multimodal.pdf` |
