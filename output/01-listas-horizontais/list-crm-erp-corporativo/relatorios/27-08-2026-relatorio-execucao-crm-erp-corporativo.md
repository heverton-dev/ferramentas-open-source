# Relatório Oficial de Execução & Telemetria · Fluxo 1: Crm Erp Corporativo

> **Data de Execução:** 27/08/2026  
> **Janela de Tempo:** Início: 16:35:10 | Término: 17:12:44 | Duração Total: 2m 14s  
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-crm-erp-corporativo.html` | 69,689 bytes | `d49696d7a50e` |
| **Markdown Denso Estruturado** | `list-crm-erp-corporativo.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-crm-erp-corporativo.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-crm-erp-corporativo.html` | HTML | `../materiais/list-crm-erp-corporativo.html` |
| **Compêndio Markdown** | `list-crm-erp-corporativo.md` | Markdown | `../materiais/list-crm-erp-corporativo.md` |
| **Compêndio PDF** | `list-crm-erp-corporativo.pdf` | PDF (Typst) | `../materiais/list-crm-erp-corporativo.pdf` |
