# Relatório Oficial de Execução & Telemetria · Fluxo 1: Marketing Digital
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-marketing-digital.html` | 124,650 bytes | `d3c5ef58b0e8` |
| **Markdown Denso Estruturado** | `list-marketing-digital.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-marketing-digital.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-marketing-digital.html` | HTML | `../materiais/list-marketing-digital.html` |
| **Compêndio Markdown** | `list-marketing-digital.md` | Markdown | `../materiais/list-marketing-digital.md` |
| **Compêndio PDF** | `list-marketing-digital.pdf` | PDF (Typst) | `../materiais/list-marketing-digital.pdf` |
