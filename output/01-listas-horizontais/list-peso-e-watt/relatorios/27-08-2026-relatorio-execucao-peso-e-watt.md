# Relatório Oficial de Execução & Telemetria · Fluxo 1: Peso E Watt
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-peso-e-watt.html` | 96,639 bytes | `9925328d1da2` |
| **Markdown Denso Estruturado** | `list-peso-e-watt.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-peso-e-watt.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-peso-e-watt.html` | HTML | `../materiais/list-peso-e-watt.html` |
| **Compêndio Markdown** | `list-peso-e-watt.md` | Markdown | `../materiais/list-peso-e-watt.md` |
| **Compêndio PDF** | `list-peso-e-watt.pdf` | PDF (Typst) | `../materiais/list-peso-e-watt.pdf` |
