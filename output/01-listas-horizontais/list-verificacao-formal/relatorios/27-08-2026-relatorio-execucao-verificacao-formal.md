# Relatório Oficial de Execução & Telemetria · Fluxo 1: Verificacao Formal
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-verificacao-formal.html` | 108,243 bytes | `948901dd386a` |
| **Markdown Denso Estruturado** | `list-verificacao-formal.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-verificacao-formal.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-verificacao-formal.html` | HTML | `../materiais/list-verificacao-formal.html` |
| **Compêndio Markdown** | `list-verificacao-formal.md` | Markdown | `../materiais/list-verificacao-formal.md` |
| **Compêndio PDF** | `list-verificacao-formal.pdf` | PDF (Typst) | `../materiais/list-verificacao-formal.pdf` |
