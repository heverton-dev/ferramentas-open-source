# Relatório Oficial de Execução & Telemetria · Fluxo 1: Arquitetura Agentica
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-arquitetura-agentica.html` | 105,341 bytes | `c22d88c58a76` |
| **Markdown Denso Estruturado** | `list-arquitetura-agentica.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-arquitetura-agentica.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-arquitetura-agentica.html` | HTML | `../materiais/list-arquitetura-agentica.html` |
| **Compêndio Markdown** | `list-arquitetura-agentica.md` | Markdown | `../materiais/list-arquitetura-agentica.md` |
| **Compêndio PDF** | `list-arquitetura-agentica.pdf` | PDF (Typst) | `../materiais/list-arquitetura-agentica.pdf` |
