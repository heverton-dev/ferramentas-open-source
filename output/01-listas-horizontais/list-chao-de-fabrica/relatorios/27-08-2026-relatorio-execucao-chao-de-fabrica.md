# Relatório Oficial de Execução & Telemetria · Fluxo 1: Chao De Fabrica
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-chao-de-fabrica.html` | 95,783 bytes | `efb7d2fa4532` |
| **Markdown Denso Estruturado** | `list-chao-de-fabrica.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-chao-de-fabrica.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-chao-de-fabrica.html` | HTML | `../materiais/list-chao-de-fabrica.html` |
| **Compêndio Markdown** | `list-chao-de-fabrica.md` | Markdown | `../materiais/list-chao-de-fabrica.md` |
| **Compêndio PDF** | `list-chao-de-fabrica.pdf` | PDF (Typst) | `../materiais/list-chao-de-fabrica.pdf` |
