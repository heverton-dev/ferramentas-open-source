# Relatório Oficial de Execução & Telemetria · Fluxo 1: Top20 Alternativas Saas

> **Data de Execução:** 27/08/2026  
> **Janela de Tempo:** Início: 16:35:10 | Término: 17:12:50 | Duração Total: 2m 14s  
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-top20-alternativas-saas.html` | 124,574 bytes | `004ffcf63439` |
| **Markdown Denso Estruturado** | `list-top20-alternativas-saas.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-top20-alternativas-saas.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-top20-alternativas-saas.html` | HTML | `../materiais/list-top20-alternativas-saas.html` |
| **Compêndio Markdown** | `list-top20-alternativas-saas.md` | Markdown | `../materiais/list-top20-alternativas-saas.md` |
| **Compêndio PDF** | `list-top20-alternativas-saas.pdf` | PDF (Typst) | `../materiais/list-top20-alternativas-saas.pdf` |
