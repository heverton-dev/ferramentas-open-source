# Relatório Oficial de Execução & Telemetria · Fluxo 1: Legaltech Gestao
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-legaltech-gestao.html` | 101,490 bytes | `34fba41c811e` |
| **Markdown Denso Estruturado** | `list-legaltech-gestao.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-legaltech-gestao.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-legaltech-gestao.html` | HTML | `../materiais/list-legaltech-gestao.html` |
| **Compêndio Markdown** | `list-legaltech-gestao.md` | Markdown | `../materiais/list-legaltech-gestao.md` |
| **Compêndio PDF** | `list-legaltech-gestao.pdf` | PDF (Typst) | `../materiais/list-legaltech-gestao.pdf` |
