# Relatório Oficial de Execução & Telemetria · Fluxo 1: Edge Ai On Device
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-edge-ai-on-device.html` | 101,305 bytes | `cc4dc8202d3e` |
| **Markdown Denso Estruturado** | `list-edge-ai-on-device.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-edge-ai-on-device.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-edge-ai-on-device.html` | HTML | `../materiais/list-edge-ai-on-device.html` |
| **Compêndio Markdown** | `list-edge-ai-on-device.md` | Markdown | `../materiais/list-edge-ai-on-device.md` |
| **Compêndio PDF** | `list-edge-ai-on-device.pdf` | PDF (Typst) | `../materiais/list-edge-ai-on-device.pdf` |
