# Relatório Oficial de Execução & Telemetria · Fluxo 1: Audio Dsp Musica
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-audio-dsp-musica.html` | 108,032 bytes | `7a0dc7ae5f7b` |
| **Markdown Denso Estruturado** | `list-audio-dsp-musica.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-audio-dsp-musica.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-audio-dsp-musica.html` | HTML | `../materiais/list-audio-dsp-musica.html` |
| **Compêndio Markdown** | `list-audio-dsp-musica.md` | Markdown | `../materiais/list-audio-dsp-musica.md` |
| **Compêndio PDF** | `list-audio-dsp-musica.pdf` | PDF (Typst) | `../materiais/list-audio-dsp-musica.pdf` |
