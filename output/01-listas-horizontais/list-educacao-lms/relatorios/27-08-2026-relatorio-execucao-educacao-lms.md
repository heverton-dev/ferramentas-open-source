# Relatório Oficial de Execução & Telemetria · Fluxo 1: Educacao Lms
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-educacao-lms.html` | 108,544 bytes | `3fabc894b3ca` |
| **Markdown Denso Estruturado** | `list-educacao-lms.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-educacao-lms.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-educacao-lms.html` | HTML | `../materiais/list-educacao-lms.html` |
| **Compêndio Markdown** | `list-educacao-lms.md` | Markdown | `../materiais/list-educacao-lms.md` |
| **Compêndio PDF** | `list-educacao-lms.pdf` | PDF (Typst) | `../materiais/list-educacao-lms.pdf` |
