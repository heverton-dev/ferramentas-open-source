# Relatório Oficial de Execução & Telemetria · Fluxo 1: Ecommerce Headless

> **Data de Execução:** 27/08/2026  
> **Janela de Tempo:** Início: 16:35:10 | Término: 17:12:45 | Duração Total: 2m 14s  
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-ecommerce-headless.html` | 108,610 bytes | `6a802f216a6c` |
| **Markdown Denso Estruturado** | `list-ecommerce-headless.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-ecommerce-headless.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-ecommerce-headless.html` | HTML | `../materiais/list-ecommerce-headless.html` |
| **Compêndio Markdown** | `list-ecommerce-headless.md` | Markdown | `../materiais/list-ecommerce-headless.md` |
| **Compêndio PDF** | `list-ecommerce-headless.pdf` | PDF (Typst) | `../materiais/list-ecommerce-headless.pdf` |
