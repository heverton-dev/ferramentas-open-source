# Relatório Oficial de Execução & Telemetria · Fluxo 1: Arquivamento Osint
...
| :--- | :--- | :--- | :--- |
| **HTML Interativo (Padrão Diamante R5)** | `list-arquivamento-osint.html` | 109,542 bytes | `b9e3c4432f25` |
| **Markdown Denso Estruturado** | `list-arquivamento-osint.md` | 0 linhas | `N/A` |
| **PDF Executivo (Typst)** | `list-arquivamento-osint.pdf` | N/A | `N/A` |
...
| :--- | :--- | :---: | :--- |
| **Compêndio Interativo** | `list-arquivamento-osint.html` | HTML | `../materiais/list-arquivamento-osint.html` |
| **Compêndio Markdown** | `list-arquivamento-osint.md` | Markdown | `../materiais/list-arquivamento-osint.md` |
| **Compêndio PDF** | `list-arquivamento-osint.pdf` | PDF (Typst) | `../materiais/list-arquivamento-osint.pdf` |
