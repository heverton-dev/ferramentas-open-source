...
**Alvo de Incorpora??o:** Ecossistema Google Workspace (Nextcloud + ONLYOFFICE + Stalwart + CryptPad)  
...
| **Mem?ria RAM** | 47.05 GB | ~3.06 GB | **~43.99 GB** | 7.0 GB | APROVADO |
...
- Mem?ria RAM abundante: 43.99 GB livres para suportar a carga de 7.0 GB com alta folga.
...
| :--- | :--- | :--- | :--- |
| Drive Service | Componente da Stack Ecossistema Google Workspace (Nextcloud + ONLYOFFICE + Stalwart + CryptPad) | `drive.vpsconexao.org` | Roteamento Traefik |
| Office Service | Componente da Stack Ecossistema Google Workspace (Nextcloud + ONLYOFFICE + Stalwart + CryptPad) | `office.vpsconexao.org` | Roteamento Traefik |
| Mail Service | Componente da Stack Ecossistema Google Workspace (Nextcloud + ONLYOFFICE + Stalwart + CryptPad) | `mail.vpsconexao.org` | Roteamento Traefik |
| Docs Service | Componente da Stack Ecossistema Google Workspace (Nextcloud + ONLYOFFICE + Stalwart + CryptPad) | `docs.vpsconexao.org` | Roteamento Traefik |
| Sso Service | Componente da Stack Ecossistema Google Workspace (Nextcloud + ONLYOFFICE + Stalwart + CryptPad) | `sso.vpsconexao.org` | Roteamento Traefik |
