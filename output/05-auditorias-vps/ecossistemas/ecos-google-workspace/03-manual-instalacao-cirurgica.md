...
- `drive.vpsconexao.org` -> Tipo A -> IP da VPS
- `office.vpsconexao.org` -> Tipo A -> IP da VPS
- `mail.vpsconexao.org` -> Tipo A -> IP da VPS
- `docs.vpsconexao.org` -> Tipo A -> IP da VPS
- `sso.vpsconexao.org` -> Tipo A -> IP da VPS
...
5. No campo **Name**, digite: `ecos-google-workspace`.
