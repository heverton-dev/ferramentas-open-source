...
Todos os servi?os foram criados dentro do namespace exclusivo da stack `ecos-google-workspace`.
...
2. No campo de busca/filtro no topo, digite: `ecos-google-workspace_`.
