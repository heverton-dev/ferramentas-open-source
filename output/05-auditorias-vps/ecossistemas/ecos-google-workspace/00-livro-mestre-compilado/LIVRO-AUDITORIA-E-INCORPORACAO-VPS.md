...
A incorporacao da stack `ecos-google-workspace` demanda **4 vCPUs** e **7.0 GB de RAM**, mantendo margem de seguranca estrita.
...
3. Nomeie a stack como: `ecos-google-workspace`.
...
### Via Portainer:
1. Acesse **Stacks**, selecione `ecos-google-workspace` e clique em **Delete this stack**.
...
2. `docker stack ls` -> Confirmar ausencia da stack `ecos-google-workspace`.
