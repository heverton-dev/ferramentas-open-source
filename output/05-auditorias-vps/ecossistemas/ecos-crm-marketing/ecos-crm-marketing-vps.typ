...
**Alvo de Incorporacao:** Ecossistema CRM & Automacao de Marketing (Chatwoot + Twenty + Evolution + Mautic)
...
+ Localize a stack `ecos-crm-marketing` e marque a caixa de sele??o ao lado dela.
