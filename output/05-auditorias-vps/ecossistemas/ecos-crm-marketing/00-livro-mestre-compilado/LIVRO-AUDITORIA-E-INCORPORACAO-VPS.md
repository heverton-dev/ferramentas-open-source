...
| **Memória RAM Global** | 47.05 GB | ~3.06 GB | **~43.99 GB** | 4.5 GB | APROVADO |
...
2. **Nome:** `Ecossistema CRM & Automacao de Marketing (Chatwoot + Twenty + Evolution + Mautic) - App Principal`.
...
3. Localize a stack `ecos-crm-marketing` e marque a caixa de seleção ao lado dela.
...
2. `docker stack ls` -> Confirme que a stack `ecos-crm-marketing` foi removida.
