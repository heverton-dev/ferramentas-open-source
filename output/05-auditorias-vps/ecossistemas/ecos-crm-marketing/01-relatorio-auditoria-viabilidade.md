...
| **Mem?ria RAM** | 47.05 GB | ~3.06 GB | **~43.99 GB** | 4.5 GB | APROVADO |
...
| :--- | :--- | :--- | :--- |
| Chat Service | Componente da Stack Ecossistema CRM & Automa??o de Marketing (Chatwoot + Twenty + Evolution + Mautic) | `chat.vpsconexao.org` | Roteamento Traefik |
| Crm Service | Componente da Stack Ecossistema CRM & Automa??o de Marketing (Chatwoot + Twenty + Evolution + Mautic) | `crm.vpsconexao.org` | Roteamento Traefik |
| Wpp Service | Componente da Stack Ecossistema CRM & Automa??o de Marketing (Chatwoot + Twenty + Evolution + Mautic) | `wpp.vpsconexao.org` | Roteamento Traefik |
| Campaigns Service | Componente da Stack Ecossistema CRM & Automa??o de Marketing (Chatwoot + Twenty + Evolution + Mautic) | `campaigns.vpsconexao.org` | Roteamento Traefik |
