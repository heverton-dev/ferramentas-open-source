...
A incorporacao da stack `ecos-rd-station-suite` demanda **4 vCPUs** e **6.5 GB de RAM**, mantendo margem de seguranca estrita.
...
| **Memoria RAM Global** | 47.05 GB | ~3.06 GB | 6.5 GB | **~37.5 GB Livres** | APROVADO |
...
| **News Service** | `https://news.vpsconexao.org` | Roteamento Traefik SNI | Ativo na Rede `network_conexao` |
...
3. Nomeie a stack como: `ecos-rd-station-suite`.
...
2. **URL:** `https://campaigns.vpsconexao.org`.
...
### Via Portainer:
1. Acesse **Stacks**, selecione `ecos-rd-station-suite` e clique em **Delete this stack**.
...
2. `docker stack ls` -> Confirmar ausencia da stack `ecos-rd-station-suite`.
