...
#align(center)[
  #block(
    ...
    [
      ...
      #v(0.5em)
      #text(size: 20pt, fill: rgb("ffffff"), weight: "bold")[Ecossistema google-workspace]\n
      #v(0.5em)
...
A VPS de producao possui *12 vCPUs* e *47.05 GB de memoria RAM*, com aproximadamente *43.99 GB de memoria livre*. A incorporacao do alvo demanda *3.0 vCPUs* e *5.0 GB de RAM*, preservando ampla margem de seguranca operacional.
...
#table(
  ...
  [Processamento], [12 vCPUs], [~1.5 vCPUs], [3.0 vCPUs], [APROVADO],
  [Memoria RAM], [47.05 GB], [~3.06 GB], [5.0 GB], [APROVADO],
