...
**Alvo de Incorporacao:** Ecossistema google-workspace  
...
| **Memoria RAM Global** | 47.05 GB | ~3.06 GB | **~43.99 GB** | 5.0 GB | APROVADO |
...
| :--- | :--- | :--- | :--- |
| **App Service** | Componente da Stack Ecossistema google-workspace | `https://app.vpsconexao.org` | Roteamento Traefik SNI |
| **Api Service** | Componente da Stack Ecossistema google-workspace | `https://api.vpsconexao.org` | Roteamento Traefik SNI |
