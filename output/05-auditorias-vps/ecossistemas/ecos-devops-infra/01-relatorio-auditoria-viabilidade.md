...
| **Mem?ria RAM** | 47.05 GB | ~3.06 GB | **~43.99 GB** | 6.0 GB | APROVADO |
...
| :--- | :--- | :--- | :--- |
| Nocodb Service | Componente da Stack Ecossistema DevOps & Engenharia de Dados (NocoDB + Supabase + n8n + Directus) | `nocodb.vpsconexao.org` | Roteamento Traefik |
| Supabase Service | Componente da Stack Ecossistema DevOps & Engenharia de Dados (NocoDB + Supabase + n8n + Directus) | `supabase.vpsconexao.org` | Roteamento Traefik |
| Directus Service | Componente da Stack Ecossistema DevOps & Engenharia de Dados (NocoDB + Supabase + n8n + Directus) | `directus.vpsconexao.org` | Roteamento Traefik |
