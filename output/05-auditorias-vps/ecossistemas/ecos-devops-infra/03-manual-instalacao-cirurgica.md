...
- `nocodb.vpsconexao.org` -> Tipo A -> IP da VPS
- `supabase.vpsconexao.org` -> Tipo A -> IP da VPS
- `directus.vpsconexao.org` -> Tipo A -> IP da VPS
...
5. No campo **Name**, digite: `ecos-devops-infra`.
