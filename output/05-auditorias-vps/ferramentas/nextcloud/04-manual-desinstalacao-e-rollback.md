...
Todos os servi?os foram criados dentro do namespace exclusivo da stack `nextcloud`.
...
3. Localize a stack `nextcloud` e marque a caixa de sele??o ao lado dela.
...
2. No campo de busca/filtro no topo, digite: `nextcloud_`.
