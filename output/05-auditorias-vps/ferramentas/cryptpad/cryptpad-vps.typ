...
#align(center)[
  #block(
    ...
    [
      ...
      #v(0.5em)
      #text(size: 22pt, fill: rgb("ffffff"), weight: "bold")[CryptPad]\n
      #v(0.5em)
...
A VPS de produção possui *12 vCPUs* e *47.05 GB de memória RAM*, operando atualmente com *~43.99 GB de memória livre*. A incorporação do alvo demanda *1.5 vCPUs* e *1.0 GB de RAM*, preservando ampla margem de segurança operacional.
