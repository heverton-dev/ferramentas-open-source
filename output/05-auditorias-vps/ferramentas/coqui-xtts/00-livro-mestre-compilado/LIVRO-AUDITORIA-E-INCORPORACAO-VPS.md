...
| :--- | :--- | :--- | :--- |
| **Coqui-xtts Service** | Componente da Stack Ferramenta coqui-xtts | `https://coqui-xtts.vpsconexao.org` | Roteamento Traefik SNI |
...
5. No campo **Name**, digite exatamente: `coqui-xtts`.
...
2. **Nome:** `Ferramenta coqui-xtts - App Principal`.
3. **URL:** `https://coqui-xtts.vpsconexao.org`.
...
3. Localize a stack `coqui-xtts` e marque a caixa de seleção ao lado dela.
...
2. `docker stack ls` -> Confirme que a stack `coqui-xtts` foi removida.
