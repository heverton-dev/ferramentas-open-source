...
Todos os servi?os foram criados dentro do namespace exclusivo da stack `chatwoot`.
...
3. Localize a stack `chatwoot` e marque a caixa de sele??o ao lado dela.
...
2. No campo de busca/filtro no topo, digite: `chatwoot_`.
