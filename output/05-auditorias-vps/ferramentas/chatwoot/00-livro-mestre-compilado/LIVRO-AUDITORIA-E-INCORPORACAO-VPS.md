...
A incorporacao da stack `chatwoot` demanda **1.5 vCPUs** e **1.5 GB de RAM**, mantendo margem de seguranca estrita.
...
3. Nomeie a stack como: `chatwoot`.
...
### Via Portainer:
1. Acesse **Stacks**, selecione `chatwoot` e clique em **Delete this stack**.
...
2. `docker stack ls` -> Confirmar ausencia da stack `chatwoot`.
