...
#align(center)[
  #block(
    ...
    [
      ...
      #v(0.4em)
      #text(size: 20pt, fill: rgb("ffffff"), weight: "bold")[Chatwoot Omnichannel]\n
      #v(0.4em)
...
2. *Namespace de Volumes Isolados:* Todos os dados persistentes sao armazenados em volumes Docker dedicados (`chatwoot_*`), impedindo sobrescrita de bancos de dados legados.
...
2. Navegue em *Stacks* > *+ Add stack* e defina o nome `chatwoot`.
...
1. *Via Portainer:* Selecione a stack `chatwoot` e clique em *Delete this stack*.
2. *Via Terminal SSH:*
```bash
