...
Todos os servi?os foram criados dentro do namespace exclusivo da stack `khoj`.
...
3. Localize a stack `khoj` e marque a caixa de sele??o ao lado dela.
...
2. No campo de busca/filtro no topo, digite: `khoj_`.
