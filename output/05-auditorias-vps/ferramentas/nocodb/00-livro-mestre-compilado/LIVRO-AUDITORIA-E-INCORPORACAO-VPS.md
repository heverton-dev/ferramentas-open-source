...
A incorporacao da stack `nocodb` demanda **1.0 vCPUs** e **1.0 GB de RAM**, mantendo margem de seguranca estrita.

| Metrica de Infraestrutura | Capacidade Total | Ocupacao Atual (Est.) | Demanda da Stack | Headroom Restante | Status |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Processamento (vCPU)** | 12 vCPUs | ~1.5 vCPUs | 1.0 vCPUs | **~9.3 vCPUs Livres** | APROVADO |
...
### Via Portainer:
1. Acesse **Stacks**, selecione `nocodb` e clique em **Delete this stack**.
...
2. `docker stack ls` -> Confirmar ausencia da stack `nocodb`.
