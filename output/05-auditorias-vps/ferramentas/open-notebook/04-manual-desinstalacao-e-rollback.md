...
Todos os servi?os foram criados dentro do namespace exclusivo da stack `open-notebook`.
...
3. Localize a stack `open-notebook` e marque a caixa de sele??o ao lado dela.
...
2. No campo de busca/filtro no topo, digite: `open-notebook_`.
