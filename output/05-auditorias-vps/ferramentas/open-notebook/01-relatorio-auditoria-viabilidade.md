...
**Alvo de Incorpora??o:** Ferramenta open-notebook  
...
| **Mem?ria RAM** | 47.05 GB | ~3.06 GB | **~43.99 GB** | 1.5 GB | APROVADO |
...
| :--- | :--- | :--- | :--- |
| Open-notebook Service | Componente da Stack Ferramenta open-notebook | `open-notebook.vpsconexao.org` | Roteamento Traefik |
