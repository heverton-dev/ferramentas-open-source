...
A incorporacao da stack `zitadel` demanda **1.5 vCPUs** e **1.5 GB de RAM**, mantendo margem de seguranca estrita.

| Metrica de Infraestrutura | Capacidade Total | Ocupacao Atual (Est.) | Demanda da Stack | Headroom Restante | Status |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Processamento (vCPU)** | 12 vCPUs | ~1.5 vCPUs | 1.5 vCPUs | **~8.8 vCPUs Livres** | APROVADO |
| **Memoria RAM Global** | 47.05 GB | ~3.06 GB | 1.5 GB | **~42.5 GB Livres** | APROVADO |
...
2. **URL:** `https://sso.vpsconexao.org`.
...
### Via Portainer:
1. Acesse **Stacks**, selecione `zitadel` e clique em **Delete this stack**.
...
2. `docker stack ls` -> Confirmar ausencia da stack `zitadel`.
