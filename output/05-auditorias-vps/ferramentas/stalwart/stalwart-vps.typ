...
2. *Namespace de Volumes Isolados:* Todos os dados persistentes sao armazenados em volumes Docker dedicados (`stalwart_*`), impedindo sobrescrita de bancos de dados legados.
...
2. Navegue em *Stacks* > *+ Add stack* e defina o nome `stalwart`.
...
- *Tipo:* HTTP(s) Monitor.
- *URL Principal:* `https://mail.vpsconexao.org`.
...
1. *Via Portainer:* Selecione a stack `stalwart` e clique em *Delete this stack*.
2. *Via Terminal SSH:*
```bash
