...
| :--- | :--- | :--- | :--- |
| **Mail Service** | Componente da Stack Stalwart All-in-One Mail Server | `https://mail.vpsconexao.org` | Roteamento Traefik SNI |
...
5. No campo **Name**, digite exatamente: `stalwart`.
...
2. **Nome:** `Stalwart All-in-One Mail Server - App Principal`.
...
3. Localize a stack `stalwart` e marque a caixa de sele??o ao lado dela.
...
2. `docker stack ls` -> Confirme que a stack `stalwart` foi removida.
