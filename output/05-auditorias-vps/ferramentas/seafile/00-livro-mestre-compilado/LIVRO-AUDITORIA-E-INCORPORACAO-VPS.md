...
A incorporacao da stack `seafile` demanda **1.5 vCPUs** e **1.5 GB de RAM**, mantendo margem de seguranca estrita.
...
2. **URL:** `https://drive.vpsconexao.org`.
...
### Via Portainer:
1. Acesse **Stacks**, selecione `seafile` e clique em **Delete this stack**.
...
2. `docker stack ls` -> Confirmar ausencia da stack `seafile`.
