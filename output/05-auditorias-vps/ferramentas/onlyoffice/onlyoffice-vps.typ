...
2. *Namespace de Volumes Isolados:* Todos os dados persistentes sao armazenados em volumes Docker dedicados (`onlyoffice_*`), impedindo sobrescrita de bancos de dados legados.
...
2. Navegue em *Stacks* > *+ Add stack* e defina o nome `onlyoffice`.
...
- *Tipo:* HTTP(s) Monitor.
- *URL Principal:* `https://office.vpsconexao.org`.
...
1. *Via Portainer:* Selecione a stack `onlyoffice` e clique em *Delete this stack*.
2. *Via Terminal SSH:*
```bash
