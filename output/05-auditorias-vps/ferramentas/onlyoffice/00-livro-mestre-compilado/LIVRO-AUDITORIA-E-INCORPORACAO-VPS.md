...
A incorporacao da stack `onlyoffice` demanda **2.0 vCPUs** e **2.5 GB de RAM**, mantendo margem de seguranca estrita.
...
3. Nomeie a stack como: `onlyoffice`.
...
2. **URL:** `https://office.vpsconexao.org`.
...
### Via Portainer:
1. Acesse **Stacks**, selecione `onlyoffice` e clique em **Delete this stack**.
...
2. `docker stack ls` -> Confirmar ausencia da stack `onlyoffice`.
