...
def compilar_playbook_fluxo1():
    ...
    md_docs = DOCS_DIR / "PLAYBOOK-MESTRE-LISTAS-HORIZONTAIS.md"
    ...
    html_docs = DOCS_DIR / "PLAYBOOK-MESTRE-LISTAS-HORIZONTAIS.html"
    html_final = f"""<!DOCTYPE html>
<html lang="pt-BR">
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Playbook Mestre: Listas Horizontais &amp; Compêndios Temáticos AIDD</title>
  <style>
...
"""
    ...
    pdf_docs = DOCS_DIR / "PLAYBOOK-MESTRE-LISTAS-HORIZONTAIS.pdf"
