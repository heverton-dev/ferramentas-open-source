...
- **R13 (Padronização Numérica e Slugs Limpos):** todos os compêndios e camadas seguem numeração sequencial contínua (`01` a `49`) com slugs descritivos em minúsculas e hífens.
